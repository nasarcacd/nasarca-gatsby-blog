...
- Gather context → Define goals → Craft precise prompts → Review & iterate
...
## 2. From User Stories to Production Using AI ⚠️

**Speaker:** Diego Barahona

**Main insight:** "AI writes code in seconds but it rarely works in production."

- The issue is not capability—it's direction
- The missing link: workflow and alignment (input → build → test → review → deploy)
...
- **Stop the MongoDB Hate!** 😄

---

## 4. From Regulation to Innovation: Implementing AI in Finance and Healthcare ✋
...
### Key Insights:
- Best use case mentioned: More time to play guitar 🎸 (half-joking, but actually true—AI handles the grunt work)
